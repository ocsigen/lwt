...
(* OASIS_START *)
(* DO NOT EDIT (digest: a235888223f198b8e9c8db574d225575) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some
              [
                 OASISText.Para
                   "A promise is a value that may become determined in the future. Lwt provides typed, composable promises. Promises that are resolved by I/O are resolved by Lwt in parallel. Meanwhile, OCaml code, including code creating and waiting on promises, runs in a single thread by default. This reduces the need for locks or other nchronization primitives. Code can be run in parallel on an opt-in basis."
              ];
          tags = [];
          categories = [];
          files_ab = [];
                              ...
                              (OASISExpr.EOr
                                 (OASISExpr.EOr
                                    (OASISExpr.EOr
                                      ...
                                      OASISExpr.ETest
                                        ("system", "linux_aout")),
                                   OASISExpr.ETest ("system", "linux_eabi")),
                                OASISExpr.ETest ("system", "linux_eabihf")),
                             true)
                        ]
                   });
               Flag
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [("src/util/style.css", None)];
                      doc_build_tools =
                  ...
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EAnd
                              (OASISExpr.EFlag "unix", OASISExpr.EFlag "ppx"),
                             true)
                        ];
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "doc/examples/unix";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "lwt-unix"; InternalLibrary "ppx"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\251\231b\"\238]k\006\244\166\189,RlL\221";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
