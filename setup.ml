...
(* OASIS_START *)
(* DO NOT EDIT (digest: f474ae7d8906ea89d731a5986ee099c9) *)
(*
            ...
            [
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "lwt"; FindlibPackage ("unix", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources =
                        [
               ...
               Library
                 ({
                     ...
                     },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EOr
                              (OASISExpr.EFlag "mmap", OASISExpr.EFlag "all"),
                             true)
                        ];
                      bs_install =
                        [
                   ...
                   {
                      lib_modules = ["Lwt_mmap"];
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "lwt";
                      lib_findlib_name = Some "mmap";
                      lib_findlib_containers = [];
                      });
               Flag
                 ({
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "mmap helpers";
                      flag_default = [(OASISExpr.EBool true, true)];
                      });
               Library
                 ({
