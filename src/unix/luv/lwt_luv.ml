  ...
  object
    ...
    method! fork =
      ...
      | Error e ->
          failwith
            (Printf.sprintf
               "Could not handle the fork, this is probably a error in Lwt, \
          ...
          lazy
            (Luv.Poll.stop poll |> function
             ...
             | Error e ->
                 failwith
                   (Printf.sprintf
                      "Could not stop read polling, this is probably a error \
                       in Lwt, please open a issue on the repo. \n\
                       Error message: %s" (Luv.Error.err_name e)))
      | Result.Error e ->
          failwith
            (Printf.sprintf
               "Could not register fd for read polling, this is probably a \
                error in Lwt, please open a issue on the repo. \n\
                Error message: %s" (Luv.Error.err_name e))
          ...
          lazy
            (Luv.Poll.stop poll |> function
             ...
             | Error e ->
                 failwith
                   (Printf.sprintf
                      "Could not stop write polling, this is probably a error \
                       in Lwt, please open a issue on the repo. \n\
                       Error message: %s" (Luv.Error.err_name e)))
      | Result.Error e ->
          failwith
            (Printf.sprintf
               "Could not register fd for write polling, this is probably a \
                error in Lwt, please open a issue on the repo. \n\
                Error message: %s" (Luv.Error.err_name e))
    ...
    method private register_timer delay repeat f =
      ...
      | Result.Error e ->
          failwith
            (Printf.sprintf
               "Could not initialize a timer, this is probably a error in Lwt, \
                please open a issue on the repo. \n\
                Error message: %s" (Luv.Error.err_name e))
      | Ok timer -> (
          let timer_fn =
          ...
          | Result.Error e ->
              failwith
                (Printf.sprintf
                   "Could not start a timer, this is probably a error in Lwt, \
                    please open a issue on the repo. \n\
                    Error message: %s" (Luv.Error.err_name e)))
  end
