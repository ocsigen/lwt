  ...
  suite "lwt_switch"
    [
      test "turn_off, add_hook" (fun () ->
          ...
          && check_6
          && check_7);
      test "turn_off: hook exception" (fun () ->
      ...
      test "with_switch: regular exit" (fun () ->
          ...
          Lwt_switch.with_switch (fun switch ->
              ...
              Lwt.return_unit)
          >|= fun () -> !hook_called);
      test "with_switch: exception" (fun () ->
          let hook_called = ref false in
      ...
      test "turn_off waits for hooks: regular exit" (fun () ->
          ...
          Lwt_switch.turn_off switch >|= fun () -> !hooks_finished = 2);
      test "turn_off waits for hooks: hook exception" (fun () ->
          let hooks_finished = ref 0 in
